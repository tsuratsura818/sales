...
from app.tasks.daily_outreach_scheduler import daily_outreach_scheduler
...
async def lifespan(app: FastAPI):
    ...
    daily_outreach_task = asyncio.create_task(daily_outreach_scheduler())
    task_cleanup_task = asyncio.create_task(task_cleanup_scheduler())
    yield
    # 終了時
    all_tasks = [worker_task, scheduler_task, monitor_task, keepalive_task, daily_plan_task, reply_task, report_task, bounce_task, heartbeat_task, health_task, task_reminder_task, recurring_task_task, wip_reminder_task, weekly_outreach_task, daily_outreach_task, task_cleanup_task]
