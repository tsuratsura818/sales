...
async def lifespan(app: FastAPI):
    ...
    yield
    # 終了時
    all_tasks = [worker_task, scheduler_task, monitor_task, keepalive_task, daily_plan_task, reply_task, report_task, bounce_task, heartbeat_task, health_task, task_reminder_task, recurring_task_task, wip_reminder_task, weekly_outreach_task, task_cleanup_task]
